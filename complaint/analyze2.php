...
if($_GET['download']==1)
{
	...
	Common::exportExcel($downloadStr,'analyze2') ;
	exit;
}
...
$export_excel="analyze2.php?download=1&class_name=$class_name&user_name=$user_name&start_date=$start_date&end_date=$end_date";
