...
$arr = array('start_date','end_date','province_id','buss_name_detail','sp_name','sp_corp_code','complaint_type','question_type','complaint_level','buss_type','sp_code','wan','buss_name');
$start_date = $end_date = $page_no = $province_id = $buss_name_detail = $sp_name = $sp_corp_code = $complaint_type = $question_type = $complaint_level = $buss_type = $sp_code =$start_date = $end_date = $wan = $buss_name = "";
